...
public class DebugRendering {
    public static final Identifier DEBUG_WHITE = Identifier.of(Synchro.MOD_ID, "textures/debug/all_white.png");
    public static final Identifier DEBUG_BLACK = Identifier.of(Synchro.MOD_ID, "textures/debug/all_black.png");
    public static final Identifier DEBUG_GRAY = Identifier.of(Synchro.MOD_ID, "textures/debug/all_gray.png");
    public static final Identifier DEBUG_SYMBOL = Identifier.of(Synchro.MOD_ID, "textures/debug/symbol.png");
