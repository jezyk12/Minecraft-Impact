...
public class SynchroModelLoadingPlugin implements ModelLoadingPlugin {
    ...
    public static final SpriteIdentifier DEFAULT_SPRITE_ID = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, new Identifier("block/bedrock"));
    public static final Identifier SLOPE_STRAIGHT_ID = new Identifier(Synchro.MOD_ID, "block/slopes/slope_straight");
    public static final Identifier SLOPE_INNER_ID = new Identifier(Synchro.MOD_ID, "block/slopes/slope_inner");
    public static final Identifier SLOPE_OUTER_ID = new Identifier(Synchro.MOD_ID, "block/slopes/slope_outer");
    public static final Identifier MILLSTONE_MOVABLE_ID = new Identifier(Synchro.MOD_ID, "block/millstone/millstone_movable");
    public static final Identifier MILLSTONE_WOOD_ID = new Identifier(Synchro.MOD_ID, "block/millstone/millstone_wood");
    @Override
