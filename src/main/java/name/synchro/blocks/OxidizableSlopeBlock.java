...
public class OxidizableSlopeBlock extends SlopeBlock implements Oxidizable{
    private static final Supplier<ImmutableBiMap<Object, Object>> SLOPE_OXIDATION_LEVEL_INCREASES = Suppliers.memoize(() -> ImmutableBiMap.builder()
            .put(RegisterBlocks.CUT_COPPER_SLOPE, RegisterBlocks.EXPOSED_CUT_COPPER_SLOPE)
            .put(RegisterBlocks.EXPOSED_CUT_COPPER_SLOPE, RegisterBlocks.WEATHERED_CUT_COPPER_SLOPE)
            .put(RegisterBlocks.WEATHERED_CUT_COPPER_SLOPE, RegisterBlocks.OXIDIZED_CUT_COPPER_SLOPE)
            .build());
