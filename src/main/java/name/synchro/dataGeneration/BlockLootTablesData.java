...
public class BlockLootTablesData extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        addDrop(BlocksRegistered.BANANA_BLOCK);
        addDrop(BlocksRegistered.BANANA_LEAVES, bananaLeavesDrop());
        addDrop(BlocksRegistered.BANANA_STEM);
        addDrop(BlocksRegistered.FERTILE_DIRT);
        addDrop(BlocksRegistered.FERTILE_FARMLAND, BlocksRegistered.FERTILE_DIRT.asItem());
        ...
        return block -> dropsWithSilkTouchOrShears(block,
                ...
                .pool(LootPool.builder().rolls(ConstantLootNumberProvider.create(1.0f))
                        .conditionally(WITHOUT_SILK_TOUCH_NOR_SHEARS).with(applyExplosionDecay(Items.STICK,
                                ItemEntry.builder(ItemsRegistered.BANANA).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(0.0f, 2.0f))))
