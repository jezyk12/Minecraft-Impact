...
public class TranslucentGasRenderHandler implements FluidRenderHandler {
    ...
    public void reloadTextures(SpriteAtlasTexture textureAtlas) {
        ...
        for (int i = 0; i < 8; ++i){
            ...
            spritesList[i][2] = textureAtlas.getSprite(textures[i]);
        }
    }
}
