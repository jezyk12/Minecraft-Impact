...
public class Cockroach extends Item {
    private static final String COCKROACH_HOLDS = "holds";
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (stack.hasNbt()){
            ...
            if (stack.getNbt().get(COCKROACH_HOLDS) instanceof NbtCompound holdsNbt) {
    ...
    protected static ItemStack driveAwayCockroach(ItemStack cockroachStack){
        if (cockroachStack.hasNbt()){
            ...
            if (cockroachStack.getNbt().get(COCKROACH_HOLDS) instanceof NbtCompound holdsNbt){
                ItemStack holds = ItemStack.fromNbt(holdsNbt);
    ...
    public static ItemStack hold(int cockroachAmount, ItemStack stack){
        ...
        compound.put(COCKROACH_HOLDS,cockroachHolds);
